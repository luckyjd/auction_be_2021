...
class Product(models.Model):
    ...
    product_name = models.CharField(max_length=256, blank=True, null=True, default='')
    ...
    product_owner_business_regis_no_place = models.CharField(max_length=256, blank=True, null=True)
    ...
    product_owner_street = models.CharField(max_length=512, blank=True, null=True)
    ...
    product_owner_represent_id_card_place = models.CharField(max_length=256, blank=True, null=True)
